...
const items = {
	GATEWAI_MANAGEMENT_KEY: "op://VAULT/ITEM/management",
};
// Not read by the console; kept in .env.local for curl-ing the proxy as a client.
// Missing access is not an error.
const optional = {
	GATEWAI_CLIENT_BEARER: "op://VAULT/ITEM/client-bearer",
};
const fixed = {
	GATEWAI_MANAGEMENT_URL: "https://gateway.example/v0/management",
